...
| What is left in a `--gunzip` run? | `gunzip-e2e-verify-ra4.json` | relay 5.4 s, verify 6.1 s, **decode 21.4 s**, other 2.8 s. Both big stages are at their measured ceilings |
