...
setup(
    ...
    install_requires = [
        ...
        'slurm_gcp_docker @ git+https://github.com/getzlab/slurm_gcp_docker@v0.16.0' if not os.path.exists("/.dockerenv") else None, # avoid circular dependency of slurm_gcp_docker -> wolf -> canine
    ],
    python_requires = ">3.7",
    classifiers = [
